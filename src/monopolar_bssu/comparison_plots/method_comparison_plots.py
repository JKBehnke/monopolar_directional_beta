...
##################################### Percentage of hemispheres with matching contacts: Heatmap of all comparisons #####################################
...
def bssu_vs_externalized_correlation(
    ...
    """
    This function correlates all methods in list_of_methods to the externalied version and compares the correlation of each method with each other
